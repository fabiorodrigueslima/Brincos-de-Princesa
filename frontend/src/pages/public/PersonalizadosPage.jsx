...
export function PersonalizadosPage() {
  return (
    <>
      <PageMeta title="Personalizados" description="Ideias, memórias e intenções podem inspirar uma peça artesanal personalizada." />
      <PageHero eyebrow="Personalizados" title="Uma intenção transformada em peça." text="Ideias, memórias e referências afetivas podem inspirar uma criação desenvolvida em conversa com você." />
      <section className="split-section container personalized-intro">
        ...
        <img src="/images/brinco-folha-dourada.png" alt="Composição de brincos artesanais usada como referência visual provisória" loading="lazy" width="1145" height="1374" />
      </section>
      <section className="section soft-section"><div className="container"><div className="custom-steps">
        <article><span>1</span><h3>Conte sua ideia</h3><p>Compartilhe referências, intenção e o que tornaria a peça especial para você.</p></article>
